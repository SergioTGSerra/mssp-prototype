...
podman compose -p "$PROJECT_NAME" -f "$(dirname "$0")/compose.yaml" --profile onlyoffice --profile talk --profile clamav --profile imaginary --profile fulltextsearch --profile whiteboard up -d
